...
const StudentProfile = ({ enrollmentNumber }) => {
  ...
  if (!student) return <p>No profile found for enrollment: {enrollmentNumber}</p>;

  return (
    <div className="max-w-5xl mx-auto p-6">
      {/* Profile Header */}
      <div className="bg-blue-600 text-white rounded-2xl shadow-lg p-6 flex items-center space-x-6">
        <img
        ...
        <div>
          ...
          <p className="text-sm text-blue-100">
            {student.branch} | Semester {student.semester} | Section{" "}
            {student.section}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow text-center border-t-4 border-yellow-500">
          <h3 className="text-lg font-semibold text-gray-600">Fees</h3>
          <p
            className={`text-2xl font-bold ${
              stats.feesStatus.includes("Paid")
                ? "text-green-600"
                : "text-red-600"
            }`}
          >
        ...
        <div className="bg-white p-4 rounded-xl shadow text-center border-t-4 border-purple-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <Link
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-lg p-6 text-center transition"
        >
        ...
        <Link
          ...
          className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-xl shadow-lg p-6 text-center transition"
        >
        ...
        <Link
          ...
          className="bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-xl shadow-lg p-6 text-center transition"
        >
